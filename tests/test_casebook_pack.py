"""Regression checks for the fathom-sim-queue-flow casebook."""
...
from casebook.harness import assert_expected, fathom_sim_queue_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_sim_queue_flow_summary(), assert_expected())
